    ...
    public function run()
    {
         $data = [
            ...
            [
              ...
              [
                'name' => '{"ru":"Физическим лицам","en":"Физическим лицам","uz":"Физическим лицам"}',
                'slug' => 'fizicheskim-litsam',
                'description' => '{"ru":"Физическим лицам","en":"Физическим лицам","uz":"Физическим лицам"}',
                'content' => '{"ru":"Физическим лицам","en":"Физическим лицам","uz":"Физическим лицам"}',
                'by_form' => '0',
                'template_form' => '0'
            ],
              [
                'name' => '{"ru":"Корпоративным клиентам","en":"Корпоративным клиентам","uz":"Корпоративным клиентам"}',
                'slug' => 'fizicheskim-litsam',
                'description' => '{"ru":Корпоративным клиентам","en":Корпоративным клиентам","uz":Корпоративным клиентам"}',
                'content' => '{"ru":Корпоративным клиентам","en":Корпоративным клиентам","uz":Корпоративным клиентам"}',
                'by_form' => '0',
                'template_form' => '0'
            ],
              [
                'name' => '{"ru":"Акционерам и инвесторам","en":"Акционерам и инвесторам","uz":"Акционерам и инвесторам"}',
                'slug' => 'atsioneram-investoram',
                'description' => '{"ru":"Акционерам и инвесторам","en":"Акционерам и инвесторам","uz":"Акционерам и инвесторам"}',
                'content' => '{"ru":"Акционерам и инвесторам","en":"Акционерам и инвесторам","uz":"Акционерам и инвесторам"}',
                'by_form' => '0',
                'template_form' => '0'
            ],
              [
                'name' => '{"ru":"   Интерактивные услуги","en":" Итерактивные услуги","uz":"  нтерактивные услуги"}',
                'slug' => 'atsioneram-investoram',
                'description' => '{"ru":" Итерактивные услуги","en":"  нтерактивные услуги","uz":"  Интерактивные услуги"}',
                'content' => '{"ru":" Итерактивные услуги","en":"  нтерактивные услуги","uz":"  Интерактивные услуги"}',
                'by_form' => '0',
                'template_form' => '0'
            ],
        ];
