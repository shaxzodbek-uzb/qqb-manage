        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="content">
                <div class="flex items-center relative shadow h-header bg-white z-20 px-view">
                    ...
                    <dropdown class="ml-auto mr-4 h-9 flex items-center dropdown-right">
                        ...
                        <dropdown-menu slot="menu" width="200" direction="rtl">
                            <ul class="list-reset">
                                <li>
                                    <a href="{{ route('locale.change', ['locale' => 'ru']) }}" class="block no-underline text-90 hover:bg-30 p-3">
                                        {{ __('locale-ru') }}
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('locale.change', ['locale' => 'uz-Latn']) }}" class="block no-underline text-90 hover:bg-30 p-3">
                                        {{ __('locale-uz-Latn') }}
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('locale.change', ['locale' => 'en']) }}" class="block no-underline text-90 hover:bg-30 p-3">
                                        {{ __('locale-en') }}
                                    </a>
                                </li>
                            </ul>
