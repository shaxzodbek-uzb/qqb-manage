...
class Credit extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Number::make(__('Min. amount'),'calculator_min_amount')->hideFromIndex()->min(0),
            Number::make(__('Max. amount'),'calculator_max_amount')->hideFromIndex()->min(0),
            Number::make(__('Period(month)'),'calculator_period')->hideFromIndex()->min(0),
            Number::make(__('Grace period(month)'),'calculator_grace_period')->hideFromIndex()->min(0),
            Number::make(__('Initial amount(%)'),'calculator_initial_amount')->hideFromIndex()->min(0),
